...
//		String host = filterServer(linkRelev.getURL().getHost());
		...
		String file = linkRelev.getURL().getFile();
		//		String host = linkRelev.getURL().getHost();
		Integer result = null;
...
//			System.out.println("Scope:" + useScope);
//			System.out.println("Host:" + hostPages.get(host));
			if(useScope == true && hostPages.get(host) != null){
				if(file.contains("rio") || file.contains("cotidiano") || file.contains("paulo") 
						|| file.contains("bairro") || file.contains("local") || file.contains("york") 
						|| file.contains("nyregion") || file.contains("chicago")){
					result = null;
				}
...
//		if(urlRelevance.get(url) != null || (scope != null && !scope.contains(filterServer(host)))){
//		if(useScope == true && hostPages.get(host) == null){
//		if(useScope == true){
//			Iterator<String> iter = hostPages.keySet().iterator();
//			result = new Integer(-1);
//			while(iter.hasNext()){
//				String tempURL = iter.next();
//				if(url.startsWith(tempURL)){
//					result = null;
////					System.out.println(">>>URL:" + url + ":" + tempURL);	
//					break;
//				}
//			}
////			System.out.println(">>>URL:" + url + "=" + result.intValue());	
//		}
...
//				result = Integer.parseInt(resStr);
//			}else{
//				Integer total = hostPages.get(host);
//				if(total != null){
//					if(total.intValue() > pagesPerSite){
//						result = new Integer(-1);
//					}else{
//						hostPages.put(host, new Integer(total.intValue()+1));				
//					}
//				}else{
//					hostPages.put(host, new Integer(1));
//				}
//			}
//			
//		}
